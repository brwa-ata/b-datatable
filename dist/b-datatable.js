...
const Ye = {
  ...
  setup(_, { emit: k }) {
    ...
    const M = w([]), I = V(
      () => q.value.length > 0 && M.value.length === q.value.length
    ), z = V(
      () => M.value.length > 0 && M.value.length < q.value.length
    );
    function H(r) {
      const p = M.value.indexOf(r);
      p === -1 ? (r.is_checked = !0, M.value.push(r)) : (r.is_checked = !1, M.value.splice(p, 1)), e("update:checked", [...M.value]);
    }
    function E() {
      I.value ? (M.value.forEach((r) => {
        r.is_checked = !1;
      }), M.value = []) : (q.value.forEach((r) => {
        r.is_checked = !0;
      }), M.value = [...q.value]), e("update:checked", [...M.value]);
    }
    let m = null;
    function B(r, p) {
      let h = r;
      for (; h && h !== p; ) {
        if (h.nodeType === 1) {
          const D = h.tagName;
          if (["BUTTON", "A", "INPUT", "SELECT", "TEXTAREA", "LABEL", "OPTION"].includes(D) || h.isContentEditable || h.getAttribute && h.getAttribute("role") === "button") return !0;
        }
        h = h.parentElement;
      }
      return !1;
    ...
    async function N(r) {
      ...
      try {
        ...
        p.value = r, p.setAttribute("readonly", ""), p.style.position = "fixed", p.style.top = "-9999px", p.style.opacity = "0", document.body.appendChild(p), p.select(), document.execCommand("copy"), document.body.removeChild(p);
      } catch {
      }
    }
    const x = w(""), L = w(null), C = w({
      startIndex: 0,
      endIndex: 0
    }), R = {
      default: 52,
      comfortable: 44,
      compact: 36
    }, ie = V(() => R[l.density] || 52), Ce = V(() => ie.value), Y = V(() => !!l.height && l.useVirtualScroll);
    function Le() {
      x.value = "";
    }
    function Me(r) {
    ...
    function Te(r) {
      const p = u.value[r];
      return p === "asc" ? { component: Re, class: "b__sort-icon-active" } : p === "desc" ? { component: Fe, class: "b__sort-icon-active" } : { component: Pe, class: "b__sort-icon-inactive" };
    }
    function Ee(r) {
      return {
    ...
    function xe(r) {
      ...
      Object.keys(u.value).forEach((h) => {
        h !== r && (u.value[h] = null);
      }), p == null ? u.value[r] = "asc" : p === "asc" ? u.value[r] = "desc" : (u.value[r] = null, r = null), l.localSort || e("update:sort", {
        column: r,
        direction: u.value[r]
      });
    }
    ...
    const he = V(() => {
      ...
      const r = Object.keys(u.value).find(
        (D) => u.value[D] !== null && u.value[D] !== void 0
      );
      if (!r)
        return he.value;
      const p = u.value[r], h = [...he.value];
      return h.sort((D, A) => {
    ...
    }), q = V(() => Ie.value), oe = V(() => (l.showExpand ? 1 : 0) + (l.showSelect ? 1 : 0));
    function de(r) {
      return Y.value ? C.value.startIndex + r : r;
    }
    function He(r, p) {
      return (typeof l.rowProps == "function" ? l.rowProps(r, p) : l.rowProps) || {};
    }
    function Ne(r, p) {
      return typeof l.rowClass == "function" ? l.rowClass(r, p) : l.rowClass;
    }
    const Ve = V(() => Y.value ? q.value.slice(C.value.startIndex, C.value.endIndex) : q.value);
    function ce() {
      if (!L.value || !Y.value)
        return;
      const r = L.value, p = r.scrollTop, h = r.clientHeight, D = q.value.length, A = l.virtualScrollBuffer, ne = ie.value, ae = Math.max(0, p - ne), pe = Math.max(0, Math.floor(ae / ie.value) - A), _e = Math.ceil(h / ie.value), ye = Math.min(D, pe + _e + A * 2);
      C.value = {
        startIndex: pe,
        endIndex: ye
      };
    ...
    return re(() => {
      ...
      () => [q.value.length, l.density, l.height],
      () => {
        Y.value && ce();
      }
    ), le(
      () => q.value,
      (r, p) => {
        e("update:currentItems", r), M.value = r.filter((h) => h.is_checked), Y.value && L.value && (Math.abs(r.length - (p?.length || 0)) > 10 && (L.value.scrollTop = 0), ce());
      },
      { immediate: !0 }
    ), (r, p) => (o(), a("div", {
      ref_key: "wrapperRef",
      ...
      class: T(["b__table-wrapper", {
        ...
        "b__border-vertical": n.value.vertical,
        "b__border-horizontal": n.value.horizontal,
        "b__border-table": n.value.table,
        "b__hover-enabled": l.hover,
        "b__virtual-scroll-enabled": Y.value,
        [`b__density-${l.density}`]: !0,
        [`b__theme-${l.theme}`]: !0
      }]),
      style: F({
        ...l.height ? { height: l.height } : {},
        ...n.value.tableBorderRadius ? { borderRadius: n.value.tableBorderRadius } : {}
      }),
      onScroll: p[2] || (p[2] = (h) => Y.value ? me() : null)
    }, [
      l.localSearch ? (o(), a("div", Je, [
        t("span", Xe, [
          ze(W(Ye))
        ]),
        X(t("input", {
      ...
      t("table", et, [
        t("thead", {
          ...
          te(r.$slots, "headers", {
            ...
            t("tr", null, [
              l.showExpand ? (o(), a("th", tt)) : S("", !0),
              l.showSelect ? (o(), a("th", lt, [
                t("input", {
                  type: "checkbox",
              ...
              (o(!0), a(O, null, U(l.headers, (h) => (o(), a("th", we({
                key: h.key
              }, { ref_for: !0 }, h.headerProps, {
                class: { b__sortable: h.sortable },
                onClick: (D) => h.sortable ? xe(h.key) : null
              }), [
                t("div", at, [
                  te(r.$slots, `header.${h.key}`, { header: h }, () => [
                    Q(j(h.title), 1)
                  ], !0),
                  h.sortable ? (o(), a("span", rt, [
                    u.value[h.key] === "asc" ? (o(), ee(W(Re), {
                      key: 0,
                      class: "b__sort-icon-active"
                    })) : u.value[h.key] === "desc" ? (o(), ee(W(Fe), {
                      key: 1,
                      class: "b__sort-icon-active"
                    })) : (o(), ee(W(Pe), {
                      key: 2,
        ...
        t("tbody", {
          ...
          l.loading && !l.items.length ? (o(), a("tr", ut, [
            t("td", {
              colspan: l.headers.length + oe.value,
          ...
          ])) : q.value.length ? (o(), a(O, { key: 1 }, [
            Y.value && C.value.startIndex > 0 ? (o(), a("tr", ct, [
              t("td", {
                colspan: l.headers.length + oe.value,
                style: F({
                  height: C.value.startIndex * Ce.value + "px",
                  padding: 0,
                  border: "none"
                })
              }, null, 12, pt)
            ])) : S("", !0),
            (o(!0), a(O, null, U(Ve.value, (h, D) => (o(), a(O, {
              key: de(D)
            }, [
              t("tr", we({ ref_for: !0 }, He(h, de(D)), {
                ...
                l.showExpand ? (o(), a("td", ft, [
                  t("button", {
                    class: T(["b__expand-btn", { "b__expand-btn--expanded": c(h) }]),
                    onClick: (A) => g(h)
                  }, [...p[5] || (p[5] = [
                    t("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                ...
                l.showSelect ? (o(), a("td", _t, [
                  t("input", {
                    id: `b__table-checkbox-${h[l.itemKey]}`,
                    type: "checkbox",
                    class: "b__select-checkbox",
                    checked: M.value.includes(h),
                    onChange: (A) => H(h)
                  }, null, 40, gt)
                ])) : S("", !0),
                (o(!0), a(O, null, U(l.headers, (A) => (o(), a("td", we({
                  key: A.key
            ...
            Y.value && C.value.endIndex < q.value.length ? (o(), a("tr", mt, [
              t("td", {
                colspan: l.headers.length + oe.value,
                style: F({
                  height: (q.value.length - C.value.endIndex) * Ce.value + "px",
                  padding: 0,
                  border: "none"
                })
              }, null, 12, yt)
  ...
  setup(_, { emit: k }) {
    const l = _, e = k, n = w(null), u = w(!1), v = w(l.defaultSymbol), c = w(""), g = w(!1), M = [
    ...
    function z(B) {
      n.value && !n.value.contains(B.target) && (u.value = !1);
    }
    re(() => document.addEventListener("click", z)), fe(() => document.removeEventListener("click", z)), le(
      () => c.value,
      (B) => {
    ...
    return (B, f) => (o(), a("div", {
      ...
      t("div", St, [
        ...
        X(t("input", {
          ...
          autocomplete: "off",
          class: "tf__input",
          onKeydown: f[2] || (f[2] = Be((i) => m(), ["enter"]))
        }, null, 40, Mt), [
          [ve, c.value]
        ]),
        t("button", {
  ...
  key: 0,
  class: "nf__dropdown"
}, Vt = ["onClick"], zt = { class: "nf__dropdown-label" }, Dt = { class: "nf__dropdown-icon" }, Pt = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  width: "16",
  ...
  emits: ["count-filter", "value-changed"],
  setup(_, { emit: k }) {
    const l = _, e = k, n = w(null), u = w(!1), v = w("__eq"), c = w(null), g = w(!1), M = w([
    ...
    function z(f) {
      n.value && !n.value.contains(f.target) && (u.value = !1);
    }
    re(() => document.addEventListener("click", z)), fe(() => document.removeEventListener("click", z)), le(
      () => c.value,
      (f) => {
        f && String(f).length || (g.value ? E() : v.value = "__eq");
      }
    );
    function H(f) {
      v.value = f, u.value = !1, c.value && m(), document.getElementById(`number-filter-search-input__${l.column}`)?.focus();
    }
    function E() {
    ...
    function m() {
      ...
      c.value = f;
      const i = l.column + v.value, y = I.value.find((N) => N.key === v.value), Z = { column: l.column, symbol: y?.value, value: c.value, columnQuery: i };
      g.value = !0, e("count-filter", { value: c.value, header: l.title }), e("value-changed", Z);
    }
    function B(f) {
      if (!f) return null;
      const i = String(f).match(/-?\d+(\.\d+)?/g);
      return i ? i.join().replaceAll(",", "") : null;
    }
    return (f, i) => (o(), a("div", {
      ...
      t("div", Ht, [
        t("div", {
          ...
          u.value ? (o(), a("ul", Nt, [
            (o(!0), a(O, null, U(M.value, (y) => (o(), a("li", {
              key: y.value,
              onClick: (Z) => H(y.value)
            }, [
              t("button", {
                ...
                t("span", Dt, [
                  ...
                  ])])) : y.value === "__not_eq" ? (o(), a("svg", jt, [...i[10] || (i[10] = [
                    t("path", { d: "M4 8H20" }, null, -1),
                    t("path", { d: "M4 16H20" }, null, -1),
...
function je(_, { itemHeight: k, overscan: l = 6 }) {
  ...
  le(e, (m) => {
    v?.disconnect(), v = null, n.value = 0, m && (g(m), typeof ResizeObserver < "u" && (v = new ResizeObserver(() => g(m)), v.observe(m)));
  }), le(_, () => {
    n.value = 0, e.value && (e.value.scrollTop = 0);
  }), Ke(() => v?.disconnect());
  const M = V(() => _.value.length * k), I = V(
    () => Math.max(0, Math.floor(n.value / k) - l)
  ), z = V(() => {
    const m = Math.ceil((u.value || k * 10) / k);
    return Math.min(_.value.length, I.value + m + l * 2);
  }), H = V(
    () => _.value.slice(I.value, z.value).map((m, B) => ({
      item: m,
      index: I.value + B
    }))
  ), E = V(() => I.value * k);
  return { containerRef: e, onScroll: c, totalHeight: M, offsetY: E, visibleItems: H };
}
const Zt = ["value", "placeholder"], Gt = {
  ...
  emits: ["count-filter", "value-changed"],
  setup(_, { emit: k }) {
    const l = _, e = k, n = w(null), u = w(!1), v = w([]), c = w(""), g = w("in"), M = V(() => {
      if (!c.value) return l.list;
      const N = c.value.toLowerCase();
      return l.list.filter((x) => i(x).toLowerCase().includes(N));
    }), { containerRef: I, onScroll: z, totalHeight: H, offsetY: E, visibleItems: m } = je(M, {
      itemHeight: al
    });
    function B(N) {
      !n.value || (typeof N.composedPath == "function" ? N.composedPath() : []).includes(n.value) || n.value.contains(N.target) || (u.value = !1);
    }
    re(() => document.addEventListener("click", B)), fe(() => document.removeEventListener("click", B));
    function f() {
      u.value = !u.value, u.value && Oe(() => {
        document.getElementById(`list-filter-search-input__${l.column}`)?.focus();
      });
    }
    function i(N) {
      return l.itemTitle.includes("&") ? l.itemTitle.split("&").map((x) => N[x]).join(" | ") : N[l.itemTitle];
    }
    function y() {
      l.list.forEach((N) => N.checked = !1), v.value = [], c.value = "", e("value-changed", { column: `${l.column}__${g.value}`, values: v.value }), u.value = !1;
    }
    function Z() {
      v.value = l.list.filter((N) => N.checked).map((N) => N[l.itemValue]), e("value-changed", { column: `${l.column}__${g.value}`, values: v.value }), u.value = !1;
    }
    return (N, x) => (o(), a("div", {
      ...
      u.value ? (o(), a("div", Gt, [
        t("div", Yt, [
          t("div", Qt, [
            ...
            t("label", {
              ...
              X(t("input", {
                "onUpdate:modelValue": x[2] || (x[2] = (L) => g.value = L),
                type: "radio",
                value: "not_in",
                class: "lf__seg-input"
              }, null, 512), [
        ...
        t("div", {
          ...
          ref: I,
          onScrollPassive: x[6] || (x[6] = (...L) => W(z) && W(z)(...L))
        }, [
          t("div", {
            class: "lf__list-sizer",
            style: F({ height: `${W(H)}px` })
          }, [
            t("div", {
              class: "lf__list-window",
              style: F({ transform: `translateY(${W(E)}px)` })
            }, [
              (o(!0), a(O, null, U(W(m), (L) => (o(), a("div", {
                key: L.index,
                class: T(["lf__list-item", { "lf__list-item--checked": L.item.checked }]),
                onClick: (C) => L.item.checked = !L.item.checked
              }, [
                t("span", ll, [
                  L.item.checked ? (o(), a("svg", ol, [...x[10] || (x[10] = [
...
}, sl = /* @__PURE__ */ se(rl, [["__scopeId", "data-v-4bee80d1"]]), il = { class: "tfl__row" }, ul = {
  key: 0,
  class: "tfl__dropdown"
  ...
  emits: ["value-changed"],
  setup(_, { emit: k }) {
    const l = _, e = k, n = w(null), u = w(!1), v = w("co"), c = w(""), g = w(!1), M = [
    ...
    re(() => document.addEventListener("click", I)), fe(() => document.removeEventListener("click", I));
    function z(B) {
  ...
  emits: ["value-changed"],
  setup(_, { emit: k }) {
    const l = _, e = k, n = w(null), u = w(!1), v = w("="), c = w(""), g = w(!1), M = [
      { title: "Equal (=)", value: "=" },
    ...
    re(() => document.addEventListener("click", I)), fe(() => document.removeEventListener("click", I));
    function z(f) {
      const i = f.match(/-?\d+(\.\d+)?/g);
      return i ? i.join("").replaceAll(",", "") : "";
    }
    function H(f) {
      v.value = f, u.value = !1, c.value.length && B(), document.getElementById(`number-filter-local-input__${l.columnKey}`)?.focus();
    }
    function E() {
      e("value-changed", { key: l.columnKey, symbol: v.value, value: c.value });
    }
    ...
    function B() {
      c.value = z(c.value), g.value = c.value.length > 0, E();
    }
    return (f, i) => (o(), a("div", {
...
function kl(_, k, l) {
  ...
  switch (k) {
    case "sw":
      return (n) => ge(n[_]).startsWith(e);
    case "ew":
      return (n) => ge(n[_]).endsWith(e);
    case "ex":
      return (n) => ge(n[_]) === e;
    case "exc":
      return (n) => !ge(n[_]).includes(e);
    case "cs": {
      const n = e.split(",").map((u) => u.trim()).filter(Boolean);
      return n.length ? (u) => {
        const v = ge(u[_]);
        return n.some((c) => v.includes(c));
      } : ke;
    }
    default:
      return (n) => ge(n[_]).includes(e);
...
function xl(_, k, l) {
  ...
  const e = new Set(l);
  return k === "not_in" ? (n) => !e.has(n[_]) : (n) => e.has(n[_]);
}
function $l(_, k) {
  switch (k.type) {
    case "text":
...
function Sl(_, k) {
  ...
  return l.length ? _.filter((e) => l.every((n) => n(e))) : _;
}
function Bl(_, k) {
  ...
  return e.sort((n, u) => {
    const v = Number(n), c = Number(u);
    return !Number.isNaN(v) && !Number.isNaN(c) ? v - c : String(n).localeCompare(String(u));
  }), e;
}
const Ll = ["value", "placeholder"], Ml = {
  ...
  emits: ["value-changed"],
  setup(_, { emit: k }) {
    const l = _, e = k, n = w(null), u = w(!1), v = w(""), c = w("in"), g = w(/* @__PURE__ */ new Set()), M = V(() => Bl(l.data, l.columnKey)), I = V(() => {
      if (!v.value) return M.value;
      const L = v.value.toLowerCase();
      return M.value.filter((C) => String(C).toLowerCase().includes(L));
    }), { containerRef: z, onScroll: H, totalHeight: E, offsetY: m, visibleItems: B } = je(I, {
      itemHeight: Rl
    });
    function f(L) {
      !n.value || (typeof L.composedPath == "function" ? L.composedPath() : []).includes(n.value) || n.value.contains(L.target) || (u.value = !1);
    }
    re(() => document.addEventListener("click", f)), fe(() => document.removeEventListener("click", f));
    function i() {
      u.value = !u.value, u.value && Oe(() => {
    ...
    function y(L) {
      ...
      C.has(L) ? C.delete(L) : C.add(L), g.value = C;
    }
    function Z() {
    ...
    return (L, C) => (o(), a("div", {
      ...
      u.value ? (o(), a("div", Ml, [
        t("div", Tl, [
          t("div", El, [
            t("label", {
              ...
              X(t("input", {
                "onUpdate:modelValue": C[1] || (C[1] = (R) => c.value = R),
                type: "radio",
                value: "in",
            ...
            t("label", {
              ...
              X(t("input", {
                "onUpdate:modelValue": C[2] || (C[2] = (R) => c.value = R),
                type: "radio",
                value: "not_in",
                class: "lfl__seg-input"
              }, null, 512), [
        ...
        t("div", Hl, [
          X(t("input", {
            "onUpdate:modelValue": C[5] || (C[5] = (R) => v.value = R),
        ...
        t("div", {
          ...
          ref_key: "containerRef",
          ref: z,
          onScrollPassive: C[6] || (C[6] = //@ts-ignore
          (...R) => W(H) && W(H)(...R))
        }, [
          t("div", {
            class: "lfl__list-sizer",
            style: F({ height: `${W(E)}px` })
          }, [
            t("div", {
              class: "lfl__list-window",
              style: F({ transform: `translateY(${W(m)}px)` })
            }, [
              (o(!0), a(O, null, U(W(B), (R) => (o(), a("div", {
                key: R.index,
                class: "lfl__list-item",
                onClick: (ie) => y(R.item)
              }, [
                t("span", zl, [
                  g.value.has(R.item) ? (o(), a("svg", Dl, [...C[10] || (C[10] = [
          ...
          I.value.length ? S("", !0) : (o(), a("div", Pl, " No options "))
        ], 544)
      ])) : S("", !0)
    ], 2));
  }
}), Ol = /* @__PURE__ */ se(Fl, [["__scopeId", "data-v-3d9d8833"]]), Al = { class: "b-dt" }, jl = { class: "b-dt__toolbar-slot" }, ql = ["disabled"], Ul = ["color", "stroke"], Kl = ["disabled"], Wl = ["color", "stroke"], Zl = ["disabled"], Gl = ["color", "stroke"], Yl = ["disabled"], Ql = ["color", "stroke"], Jl = {
  key: 1,
  class: "b-dt__spinner",
  xmlns: "http://www.w3.org/2000/svg",
  width: "17",
  ...
  key: 0,
  class: "b__sort-icon"
}, wo = { key: 0 }, bo = { key: 1 }, mo = { class: "b__sticky-table-footer" }, yo = { key: 0 }, ko = { key: 1 }, Co = /* @__PURE__ */ be({
  __name: "BDatatable",
  props: {
    hover: { type: Boolean, default: !1 },
  ...
  setup(_, { expose: k, emit: l }) {
    ...
    ), v = V(() => e.tableToolbarBgColor ? { backgroundColor: e.tableToolbarBgColor } : {}), c = V(() => e.perPageOptions), g = w(null), M = w(!1), I = w(null), z = w(!1), H = w(/* @__PURE__ */ new Set()), E = w([]), m = w(null), B = w(null);
    function f() {
      if (!(!e.storeTableHeaderInLocalStorage || !e.tableHeaderLocalStorageName))
        try {
          const s = localStorage.getItem(e.tableHeaderLocalStorageName);
          s && (H.value = new Set(JSON.parse(s)));
        } catch {
        }
    }
    function i() {
    ...
    function y() {
      if (!(!e.storeTableHeaderInLocalStorage || !e.tableHeaderLocalStorageName))
        try {
          ...
          if (s) {
            const d = JSON.parse(s), b = new Set(e.headers.map((J) => J.key)), P = d.filter((J) => b.has(J)), G = new Set(P);
            E.value = [...P, ...e.headers.filter((J) => !G.has(J.key)).map((J) => J.key)];
          }
        } catch {
        }
    }
    ...
    le(H, i, { deep: !0 }), le(E, Z, { deep: !0 });
    const N = V(() => {
      const s = new Map(e.headers.map((d) => [d.key, d]));
      return E.value.filter((d) => !H.value.has(d)).map((d) => s.get(d)).filter(Boolean);
    });
    le(
      () => N.value,
      (s) => {
    ...
    function x(s) {
      g.value && !g.value.contains(s.target) && (M.value = !1), I.value && !I.value.contains(s.target) && (z.value = !1);
    }
    re(() => {
      E.value = e.headers.map((s) => s.key), y(), f(), document.addEventListener("click", x);
    }), fe(() => {
      document.removeEventListener("click", x);
    });
    function L(s) {
      n("update:per-page", { perPage: s, page: 1 }), M.value = !1;
    }
    function C() {
      e.page > 1 && n("update:prev-page", e.page - 1);
    }
    function R() {
      e.apiData.next && n("update:next-page", e.page + 1);
    }
    function ie() {
      n("click:reset");
    }
    ...
    function Le() {
      n("click:export-to-excel");
    }
    function Me(s) {
      const d = new Set(H.value);
      d.has(s) ? d.delete(s) : d.add(s), H.value = d;
    }
    function Te(s, d) {
      m.value = d, s.dataTransfer && (s.dataTransfer.effectAllowed = "move", s.dataTransfer.setData("text/plain", String(d)));
    }
    function Ee(s, d) {
      s.preventDefault(), s.dataTransfer && (s.dataTransfer.dropEffect = "move"), B.value = d;
    }
    function xe(s, d) {
      if (s.preventDefault(), m.value === null || m.value === d) {
        m.value = null, B.value = null;
        return;
      }
      const b = [...E.value], [P] = b.splice(m.value, 1);
      b.splice(d, 0, P), E.value = b, m.value = null, B.value = null;
    }
    function ue() {
      m.value = null, B.value = null;
    }
    function he() {
      E.value = e.headers.map((s) => s.key), H.value = /* @__PURE__ */ new Set();
    }
    function Ie() {
      return {};
    }
    ...
    const ce = V(() => e.apiData.results), me = w({}), r = V(() => e.localFilter ? Sl(ce.value, me.value) : e.apiData.results);
    function p(s, d) {
      const b = { ...me.value };
    ...
    function ne(s) {
      n("update:text-filter", s);
    }
    function ae(s) {
      n("update:number-filter", s);
    }
    function pe(s) {
      n("update:list-filter", s);
    }
    function _e(s) {
      n("update:sort", s);
    }
    function ye(s, d = null, b = !1) {
    ...
    return k({
      ...
      t("div", {
        ...
        t("div", jl, [
          te(s.$slots, "prepend-table-toolbar", {}, void 0, !0)
        ]),
        u.value ? (o(), a("div", {
          key: 0,
          ...
          e.showExportToExcelBtn ? (o(), a("button", {
            ...
            e.exportLoading ? (o(), a("svg", Jl, [...d[11] || (d[11] = [
              t("circle", {
                cx: "12",
                cy: "12",
                r: "10",
          ...
          e.showToggleHeaderBtn ? (o(), a("div", {
            ...
            t("button", {
              ...
              disabled: e.loading,
              onClick: d[2] || (d[2] = (b) => z.value = !z.value)
            }, [
              (o(), a("svg", {
                xmlns: "http://www.w3.org/2000/svg",
                viewBox: "0 0 24 24",
                ...
                De('<path d="M3.89124 20.1088C2.5 18.7175 2.5 16.4783 2.5 12C2.5 7.52166 2.5 5.28249 3.89124 3.89124C5.28249 2.5 7.52166 2.5 12 2.5C16.4783 2.5 18.7175 2.5 20.1088 3.89124C21.5 5.28249 21.5 7.52166 21.5 12C21.5 16.4783 21.5 18.7175 20.1088 20.1088C18.7175 21.5 16.4783 21.5 12 21.5C7.52166 21.5 5.28249 21.5 3.89124 20.1088Z" stroke-linecap="round" stroke-linejoin="round" data-v-972a7ae2></path><path d="M2.5 9L21.5 9" data-v-972a7ae2></path><path d="M2.5 13L21.5 13" data-v-972a7ae2></path><path d="M2.5 17L21.5 17" data-v-972a7ae2></path><path d="M12 21.5L12 9" stroke-linecap="round" data-v-972a7ae2></path>', 5)
              ])], 8, eo))
            ], 10, Xl),
            z.value ? (o(), a("div", to, [
              t("ul", lo, [
                (o(!0), a(O, null, U(E.value, (b, P) => (o(), a("li", {
                  key: b,
                  class: T(["b-dt__columns-item b-dt__reorder-item", {
                    "b-dt__reorder-item--dragging": m.value === P,
                    "b-dt__reorder-item--dragover": B.value === P && m.value !== P
                  }]),
                  draggable: "true",
                  onClick: (G) => Me(b),
                  onDragstart: (G) => Te(G, P),
                  onDragover: (G) => Ee(G, P),
                  onDrop: (G) => xe(G, P),
                  onDragend: ue
                }, [
                  ...
                  t("span", no, [
                    H.value.has(b) ? S("", !0) : (o(), a("svg", ao, [...d[14] || (d[14] = [
        ...
        t("div", ro, [
          e.showPerPageBtn ? (o(), a("div", {
            ...
            t("button", {
              ...
              disabled: e.loading,
              style: F(v.value),
              onClick: d[4] || (d[4] = (b) => M.value = !M.value)
            }, [
              Q(j(e.perPage) + " ", 1),
              d[15] || (d[15] = t("svg", {
                xmlns: "http://www.w3.org/2000/svg",
            ...
            M.value ? (o(), a("ul", io, [
              (o(!0), a(O, null, U(c.value, (b) => (o(), a("li", {
                key: b,
          ...
          e.showPrevAndNextBtn ? (o(), a(O, { key: 1 }, [
            t("span", {
      ...
      ze(Ae, we({
        ...
        "onUpdate:sort": _e,
        "onUpdate:currentItems": q,
        "onRow:expand": oe,
        "onUpdate:expanded": de,
        "onUpdate:checked": He,
        "onClick:row": Ne,
        "onDbClick:row": Ve,
        "copy-on-cell-click": e.copyOnCellClick
      }, s.$attrs), Ze({
        headers: $e(({ columns: b, getSortIcon: P, toggleSort: G, isAllChecked: J, isIndeterminate: qe, toggleAllChecked: Ue }) => [
          t("tr", null, [
            e.showExpand ? (o(), a("th", {
              key: 0,
              class: "b__expand-th",
              style: F(`background-color: ${e.headerRowBgColor}`)
            }, null, 4)) : S("", !0),
            e.showSelect ? (o(), a("th", {
              key: 1,
              class: "b__select-th",
            ...
            (o(!0), a(O, null, U(b, ($) => (o(), a("th", we({
              key: $.key
            }, { ref_for: !0 }, $.headerProps, {
              class: { b__sortable: $.sortable },
              style: `background-color: ${e.headerRowBgColor}`,
              onClick: ($o) => $.sortable ? G($.key) : null
            }), [
              t("div", {
                class: "b__header-content",
                style: F($.align ? { justifyContent: $.align } : {})
              }, [
                Q(j($.title) + " ", 1),
                $.sortable ? (o(), a("span", go, [
                  (o(), ee(Ge(P($.key).component), {
                    class: T(P($.key).class)
                  }, null, 8, ["class"]))
                ])) : S("", !0)
              ], 4)
          ...
          t("tr", null, [
            e.showExpand ? (o(), a("td", {
              key: 0,
              style: F(`background-color: ${e.filterHeaderRowBgColor}`),
              class: "b__expand-th"
            }, null, 4)) : S("", !0),
            e.showSelect ? (o(), a("td", {
              key: 1,
            ...
            (o(!0), a(O, null, U(b, ($) => (o(), a("td", we({
              key: $.key,
              style: [{ height: "30px !important" }, `background-color: ${e.filterHeaderRowBgColor}`]
            }, { ref_for: !0 }, $.headerProps), [
              e.localFilter ? (o(), a(O, { key: 0 }, [
                $.filterType === "text" ? (o(), ee(fl, {
                  key: 0,
                  title: $.title,
                  "column-key": $.key,
                  "default-symbol": $?.defaultSymbol ?? e.defaultTextSymbol,
                  onValueChanged: h
                }, null, 8, ["title", "column-key", "default-symbol"])) : $.filterType === "number" ? (o(), ee(yl, {
                  key: 1,
                  title: $.title,
                  "column-key": $.key,
                  onValueChanged: D
                }, null, 8, ["title", "column-key"])) : $.filterType === "list" ? (o(), ee(Ol, {
                  key: 2,
                  "column-key": $.key,
                  data: ce.value,
                  onValueChanged: A
                ...
                $.filterType === "text" ? (o(), ee(It, {
                  key: 0,
                  title: $.title,
                  column: $.column,
                  "default-symbol": $?.defaultSymbol ?? e.defaultTextSymbol,
                  onValueChanged: ne
                }, null, 8, ["title", "column", "default-symbol"])) : $.filterType === "number" ? (o(), ee(Wt, {
                  key: 1,
                  title: $.title,
                  column: $.column,
                  ...
                  onValueChanged: ae
                }, null, 8, ["title", "column", "columns", "complex"])) : $.filterType === "list" && $.list && $.list.length ? (o(), ee(sl, {
                  key: 2,
                  column: $.column,
        ...
        "b-expanded-row": $e(({ index: b, item: P }) => [
        ...
        U(e.bodySlots, (b, P) => ({
          name: `item.${b}`,
          fn: $e(({ index: G, item: J }) => [
            b === "counter_column" ? (o(), a("div", wo, j(G + 1), 1)) : (o(), a("div", bo, [
        ...
        e.showTotals && e?.apiData?.footer ? {
          ...
          fn: $e(() => [
            t("tr", mo, [
              ...
              (o(!0), a(O, null, U(N.value, (b, P) => (o(), a("td", {
                key: P,
                style: F(`background-color: ${e.headerRowBgColor}`),
                class: T(e.footerClass)
              }, [
                b.key === "counter_column" ? (o(), a("div", yo)) : (o(), a("div", ko, j(ye(e.apiData.footer[b.key])), 1))
              ], 6))), 128))
            ])
          ]),
          key: "0"
...
}), xo = /* @__PURE__ */ se(Co, [["__scopeId", "data-v-972a7ae2"]]), Bo = {
  install(_) {
